...
export function ProductCard({ product }: ProductCardProps) {
  ...
  const whatsappMessage = encodeURIComponent(
    `Olá! Tenho interesse no produto: ${product.name} - R$ ${product.price.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}`
  );
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="mt-auto space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            ou 12x de R$ {installmentPrice.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
          </p>
        </div>
        ...
        <div className="mt-4 flex gap-2">
          <Button
            className="flex-1 bg-gradient-to-r from-secondary to-primary text-primary-foreground hover:opacity-90"
            size="sm"
          >
          ...
          <Button
            ...
            asChild
          >
            <a href={whatsappLink} target="_blank" rel="noopener noreferrer" aria-label="Comprar via WhatsApp">
